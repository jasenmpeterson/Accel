	...
	<nav class="site-navigation top-bar" role="navigation">
		<div class="top-bar-left">
			<div class="site-desktop-title top-bar-title">
				<a href="#home" rel="home" class="logo-container">
...
<div class="about-wrap" id="product" data-section="Product">
	...
	<div class="how-it-works" id="how-it-works" data-section="How to Info">
		<div class="row">
	...
	<div class="comparison-table" id="technical-data" data-section="Technical Data">
		<div class="row">
			<div class="small-12 column text-center">
	...
	<div class="about-santrol" id="about" data-section="About">
		<div class="row">
		...
		<div class="row align-center">
			<?php
				foreach($industrial[0]['products'] as $product):
					echo '<div class="small-12 medium-3 columns"><a target="_blank" href="'.$product['page_link'].'" data-interchange="['.$product['image']['sizes']['fp-small'].', small],['.$product['image']['sizes']['fp-medium'].', medium],['.$product['image']['sizes']['fp-large'].', large],['.$product['image']['sizes']['fp-xlarge'].', xlarge]"><div class="product-wrap" >'.$product['title'].'</div></a></div>';
				endforeach;
			?>
		</div>
	</div>
